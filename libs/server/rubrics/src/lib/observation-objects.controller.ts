...
export class ObservationObjectsController {
  constructor( private readonly observationObjectsService: ObservationObjectsService ) {}
  ...
  @ApiBearerAuth()
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Inserisce a sistema un nuovo oggetto di osservazione' })
  create(@Body(ValidationPipe) createObservationObjectDto: CreateObservationObjectDto) {
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Recupera l\'elenco di tutti gli oggetti di osservazione disponibili' })
  findAll() {
  ...
  @UseGuards(JwtAuthGuard)
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Recupera il dettaglio di un singolo oggetto di osservazione' })
  @ApiParam({ name: 'id', type: 'number', description: 'ID numerico dell\'oggetto di osservazione' })
  ...
  @ApiParam({ name: 'id', type: 'number', description: 'ID numerico dell\'oggetto di osservazione da aggiornare' })
  update(@Param('id', ParseIntPipe) id: number, @Body(ValidationPipe) updateIndicatorDto: UpdateObservationObjectDto) {
  ...
  @Roles(UserRole.ADMIN)
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Elimina un oggetto di osservazione dal sistema' })
  @ApiParam({ name: 'id', type: 'number', description: 'ID numerico dell\'oggetto di osservazione da eliminare' })
